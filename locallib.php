...
function displaydate($datetext) {
    ...
    if ($dateparts[2] && ($CFG->lang == 'fr')) {
        ...
        if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Monday") {

            $day = "Lundi";
        } else if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Tuesday") {

            $day = "Mardi";
        } else if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Wednesday") {

            $day = "Mercredi";
        } else if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Thursday") {

            $day = "Jeudi";
        } else if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Friday") {

            $day = "Vendredi";
        } else if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Saturday") {

            $day = "Samedi";
        } else if (date("l", mktime(0,0,0, $dateparts[1], $dateparts[2], $dateparts[0])) == "Sunday") {
